...
var Footer = function (_JSXComponent) {
    ...
    _createClass(Footer, [{
        ...
        value: function render() {
            ...
            IncrementalDOM.text('Icons made by ');
            IncrementalDOM.elementOpen('a', null, null, 'href', 'https://www.flaticon.com/authors/simpleicon', 'title', 'SimpleIcon');
            IncrementalDOM.text('SimpleIcon');
            IncrementalDOM.elementClose('a');
            IncrementalDOM.text(' from ');
            IncrementalDOM.elementOpen('a', null, null, 'href', 'https://www.flaticon.com/', 'title', 'Flaticon');
            IncrementalDOM.text('www.flaticon.com');
            IncrementalDOM.elementClose('a');
            IncrementalDOM.text(' is licensed by ');
            IncrementalDOM.elementOpen('a', null, null, 'href', 'http://creativecommons.org/licenses/by/3.0/', 'title', 'Creative Commons BY 3.0', 'target', '_blank');
            IncrementalDOM.text('CC 3.0 BY');
            IncrementalDOM.elementClose('a');
            IncrementalDOM.elementClose('div');
            IncrementalDOM.elementClose('div');
            IncrementalDOM.elementClose('div');
